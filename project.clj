(defproject com.github.piotr-yuxuan/slava-record (-> "./resources/slava-record.version" slurp .trim)
  ...
  :profiles {:dev {:jvm-opts ["-Dclojure.compiler.disable-locals-clearing=true"]}
             :test {:dependencies [[com.bakdata.fluent-kafka-streams-tests/schema-registry-mock "2.8.0"]
                                   [org.apache.kafka/kafka-clients "7.3.1-ce"]
                                   [org.apache.kafka/kafka-streams-test-utils "7.3.1-ce"]]}
